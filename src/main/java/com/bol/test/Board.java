...
public class Board {
	...
	{	
		...
		if(stones%14<=6 && stones%14>=1 && board[stones%14]==1 && board[14-stones%14]!=0 && playerIndex==0)
		{
		...
		if(stones%14<=13 && stones%14>=8 && board[stones%14]==1 && board[14-stones%14]!=0 && playerIndex==7)
		{
			System.out.println("You will add " + board[14-(stones%14)] +" stones to big pit");
	...
	{	int i;
		...
		printBoard();
		if(player1StoneCount>player2StoneCount) System.out.println("\nPlayer1 wins!\n");
		else if(player1StoneCount<player2StoneCount)  System.out.println("\nPlayer2 wins\n");
